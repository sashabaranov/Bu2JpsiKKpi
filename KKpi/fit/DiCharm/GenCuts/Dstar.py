...
# =============================================================================
# from DiCharm.GenCuts.CheckGen import Dstar, configure_alg, run
from DiCharm.CheckGen import Dstar, configure_alg, run
...
def configure(datafiles, catalogs=[]):
    ...
    configure the job
    """
    return configure_alg(Dstar, datafiles, catalogs)
