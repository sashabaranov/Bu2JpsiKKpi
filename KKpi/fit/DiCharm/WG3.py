...
class B2Keta (Algo):
    ...
    def analyse(self):
        ...
        for b in b1K:
            ...
            tup1K.column_float('mass', self.mfit(b) / GeV)
            tup1K.column_float('c2dtf', self.c2dtf(b))
        ...
        for b in b2K:
            ...
            tup2K.column_float('mass', self.mfit(b) / GeV)
            tup2K.column_float('c2dtf', self.c2dtf(b))
...
def configure(datafiles,
    ...
    davinci = DaVinci(
        ...
        EvtMax=-1,
        #
        HistogramFile='WGv3_Histos.root',
        TupleFile='WGv3.root',
        #
        Lumi=True,
        #
