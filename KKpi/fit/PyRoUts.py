#!/usr/bin/env python
# =============================================================================
# $Id: PyRoUts.py 161187 2013-08-10 13:32:02Z ibelyaev $
# =============================================================================
# @file
...
#
#                    $Revision: 161187 $
#  Last modification $Date: 2013-08-10 15:32:02 +0200 (Sat, 10 Aug 2013) $
#  by                $Author: ibelyaev $
# =============================================================================
"""
...
def hToGraph2(h1, bias):
    ...
    funcx = lambda x, y: (
        x.value() + x.error() * bias, x.error() * (1 + bias), x.error() * (1 - bias))
...
def _mn_exec_(self, command, *args):
    ...
    if not args:
        args = [0]
        logger.warning(
            'TMinuit::execute: empty vector replaced with  %s ' % args)
