...
# =============================================================================
OUTPUT_DIR = '/afs/cern.ch/user/a/albarano/cmtuser/Bender_v22r8/Scripts/testing/output/'

def append_dir(directory, files):
    import os
    return [os.path.join(directory, f) for f in files]

data5 = append_dir(OUTPUT_DIR, ['B2JpsiKKpi-2011.root',  'B2JpsiKKpi-2012.root'])
data6 = append_dir(OUTPUT_DIR, ['B2JpsiKKpi-2011-sel6.root',  'B2JpsiKKpi-2012-sel6.root'])

selection5 = DataAndLumi(branch='JpsiKKpi/t', files=data5)
selection6 = DataAndLumi(branch='JpsiKKpi/t', files=data6)
