...
class SBT(SelectorWithCuts):
    ...
    def __init__(self,
        ...
        self.pt_pion = ROOT.RooRealVar("pt_kaon", "", -0.5, 6.0)
        self.eta_pion = ROOT.RooRealVar("eta_kaon", "", -0.5, 6.0)
        ...
        self.pt_pion = ROOT.RooRealVar("pt_pion", "", -0.5, 20.0)
        self.p_pion  = ROOT.RooRealVar("p_pion", "", -0.5, 40.0)
        self.eta_pion = ROOT.RooRealVar("eta_pion", "", -0.5, 20.0)

        self.m_b_misid = ROOT.RooRealVar("m_b_misid", "", -0.5, 20.0)
        ...
        self.varset.add(self.pt_pion)
        self.varset.add(self.eta_pion)
    ...
    def Process(self, entry):
        ...
        self.pt_kaon.setVal(bamboo.pt_kaon[0])
        self.eta_kaon.setVal(bamboo.eta_kaon[0])
        self.pt_pion.setVal(bamboo.pt_pion[1])
        self.eta_pion.setVal(bamboo.eta_pion[1])
        ...
        self.pt_pion.setVal(float(bamboo.pt_pion[0]))
        self.p_pion.setVal(float(bamboo.p_pion[0]))
        self.eta_pion.setVal(float(bamboo.eta_pion[0]))
