...
# data6 = append_dir(OUTPUT_DIR, ['RD-2011-sel6.root' ]) + from_ganga(43)
data6 = from_ganga(42) + from_ganga(43)

selection5 = DataAndLumi(branch='JpsiKpipi/t', files=data5)
selection6 = DataAndLumi(branch='JpsiKpipi/t', files=data6)
...
# =============================================================================
MC_OUTPUTDIR = '$Kpipidir/MC/output/'
...
mc_pythia6 = append_dir(MC_OUTPUTDIR, ['2011-Kpipi-Pythia6.root', '2012-Kpipi-Pythia6.root'])
mc_pythia8 = append_dir(MC_OUTPUTDIR, ['2011-Kpipi-Pythia8.root', '2012-Kpipi-Pythia8.root'])
