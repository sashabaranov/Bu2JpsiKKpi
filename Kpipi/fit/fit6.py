...
from data_Bc import selection6
...
cuts_s6 = "&& ann_pion > 0.15 && MIPCHI2DV_k > 9 && MIPCHI2DV_pi1 > 9 && MIPCHI2DV_pi2 > 9"
cuts_Bu += cuts_s6
...
with rooSilent():
    logger.info('Fit B+ histogram (check the model)')
