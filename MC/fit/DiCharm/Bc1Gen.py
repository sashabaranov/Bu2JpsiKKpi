...
class BcGen (AlgoMC):
    ...
    def analyse(self):
        ...
        bc = self.gselect(
            'bc',
            ('B_c+' == GABSID) & (GINTREE('J/psi(1S)' == GID)) & (GINTREE('D_s+' == GABSID)))
        ...
        if bc.empty():
            ...
            # bc = self.gselect ( 'bcc' , 'B_c+' == GABSID )
            # print bc
            return SUCCESS

        tup = self.nTuple('Bc')

        # psi = LoKi.GenChild.Selector ( '[ B_c+ --> ^J/psi(1S)  D_s+ ... ]CC' )
        # ds  = LoKi.GenChild.Selector ( '[ B_c+ -->  J/psi(1S) ^D_s+ ... ]CC' )
        psi = LoKi.GenChild.Selector('J/psi(1S)' == GID)
...
if '__main__' == __name__:
    ...
    # ]
    input = [
        # '/afs/cern.ch/user/i/ibelyaev/cmtuser/Gauss_v42r2/Gauss-14175005-1000ev-20121124.gen'
        # '/afs/cern.ch/user/i/ibelyaev/cmtuser/Gauss_v42r2/Gauss-14175005-2000ev-20121124.gen'
        '/afs/cern.ch/user/i/ibelyaev/cmtuser/Gauss_v42r2/Gauss-14175005-10000ev-20121124.gen'
    ]
