...
#
tBu2 = ROOT.TChain('MCBu2JpsiKpipi/NTuple_for_B-mesons')


outputdir = '/afs/cern.ch/user/a/albarano/cmtuser/Bender_v22r8/Scripts/Bu2JpsiKpipi/MC/output/'
files = ['2012-Kpipi-Pythia8.root']
nFiles = len(files)
