...
# @file
#
# Simple script to get the generator cuts acceptance for D0 from D*+
#
...
# =============================================================================
# from DiCharm.GenCuts.CheckGen import D0, configure_alg, run
from DiCharm.CheckGen import D0, configure_alg, run
...
def configure(datafiles, catalogs=[]):
    ...
    configure the job
    """
    return configure_alg(D0, datafiles, catalogs)
