...
# $Id:$
# =============================================================================
# @file  DiCharm/Trigger/FitTisTos.py
#
...
# ========================================================================
# simple function fo rfit Tis/Tos histograms
...
def fitTisTos(func,
    ...
    for key in keys:
        ...
        for h in hists:
            if m0_.value() > 0 and s0_.value() > 0:
                n, r = func(
                    h, fitfunc, fixMass=m0_.value(), fixSigma=s0_.value())
            else:
                n, r = func(h, fitfunc)
        ...
        eTOS = 1.0 / (1 + nums[3] / nums[2])

        nTotal += nums[0]
        nBefore = nums[1] + nums[2] + nums[3] + nums[1] * nums[3] / nums[2]
        nCorr += nBefore

        tistos[key] = eTOS, nums

        print ' key, nums : ', key, eTOS, nums, m0_, s0_, b0_
    ...
    print ' #total ', nTotal, nCorr, nTotal / nCorr, etos
    return tistos, histos[1], histos[2]
