varlist = [
    ...
    # Kinematics
    # ("pt_pion", 25, -0.5, 3.0, "p_{T}(\pi)"),
    # ("eta_pion", 25, 2.0, 5.5, "\eta(\pi)"),
    # ("p_pion", 25, 3.0, 20.0, "p(\pi)"),

    # ("pt_kaon[0]", 25, -0.5, 5.0, "p_{T}(K1)"),
    # ("eta_kaon[0]", 25, 2.0, 5.5, "\eta(K1)"),
    # ("p_kaon[0]", 25, 3.0, 20.0, "p(K1)"),

    # ("pt_kaon[1]", 25, -0.5, 5.0, "p_{T}(K2)"),
    # ("eta_kaon[1]", 25, 2.0, 5.5, "\eta(K2)"),
    # ("p_kaon[1]", 25, 3.0, 20.0, "p(K2)"),
]